    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#0c0c0e] overflow-hidden font-sans">
      ...
      >
        <div className="text-center mb-[34px] flex flex-col items-center">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-[#ef2950]/20 to-transparent opacity-50" />
        ...
        >
          <button type="button" aria-label="button" 
            ...
            className="w-full py-[15px] px-4 flex justify-center items-center bg-[#ef2950] text-white font-bold font-sans rounded-xl hover:bg-[#ff3b61] transition-all active:scale-[0.98] shadow-lg text-[15px] tracking-wide"
          >
             Join Getnayi
          </button>
