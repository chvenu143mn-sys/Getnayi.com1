...
export function GuestGate({ type, title, description, onClose }: GuestGateProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#0c0c0e] overflow-hidden font-sans">
      ...
      >
        <div className="mb-6 h-[46px] w-[46px] rounded-[14px] flex items-center justify-center border-2 border-white bg-transparent shrink-0">
        ...
        <div className="w-full space-y-[18px] mb-[45px] max-w-[280px]">
          <div className="flex items-center space-x-3 text-white">
             <svg className="w-[18px] h-[18px] shrink-0" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="12" fill="white"/><path d="M16 8.5L9.5 15L6 11.5" stroke="black" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
