  ...
  return (
    <div className="gap-y-6 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-zinc-500 text-xs mt-1">Audit out-bound store domains, check trust parameters, and issue verified badges.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-[#141416] border border-white/5 rounded-2xl p-4 flex items-center justify-between">
          <div>
            <p className="text-zinc-500 text-[10px] font-mono tracking-wider uppercase">Active Product Links</p>
        ...
        <div className="bg-[#141416] border border-white/5 rounded-2xl p-4 flex items-center justify-between">
          <div>
            <p className="text-zinc-500 text-[10px] font-mono tracking-wider uppercase">Verified Listings</p>
        ...
        <div className="bg-[#141416] border border-white/5 rounded-2xl p-4 flex items-center justify-between">
          <div>
            <p className="text-zinc-500 text-[10px] font-mono tracking-wider uppercase">Unverified Listings</p>
            <p className="text-xl font-bold text-white mt-1">
              {products.filter(p => !p.is_verified).length}
            </p>
          </div>
            ...
            <tbody className="divide-y divide-white/5 text-xs font-medium">
              {filtered.map((prod) => (
                <tr key={prod.id} className="hover:bg-white/[0.01] transition-all">
                  ...
                  <td className="py-4 px-5">
                    <span className="font-mono text-[11px] text-zinc-500 bg-white/5 border border-white/5 px-2 py-0.5 rounded">
                      {prod.domain}
                    </span>
                  </td>
                  <td className="py-4 px-5">
