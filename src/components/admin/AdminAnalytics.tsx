...
export default function AdminAnalytics({
  ...
  return (
    <div className="gap-y-6 animate-in fade-in duration-500">
      <div>
        <h1 className="text-2xl font-bold text-text-primary tracking-tight">Platform Analytics & Trends</h1>
        <p className="text-text-secondary text-xs mt-1">Holistic usage charts charting creator retention, video growth rates, and category distribution ratios.</p>
      </div>

      {/* Grid Summary Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-[#141416] p-5 border border-border-subtle rounded-2xl">
          <p className="text-text-secondary text-xs font-mono uppercase tracking-wider">Uploader Conversion Rate</p>
          <p className="text-brand-primaryxl font-bold text-text-primary mt-1.5">
        ...
        <div className="bg-[#141416] p-5 border border-border-subtle rounded-2xl">
          <p className="text-text-secondary text-xs font-mono uppercase tracking-wider">Average Upload Velocity</p>
          <p className="text-brand-primaryxl font-bold text-text-primary mt-1.5">
        ...
        <div className="bg-[#141416] p-5 border border-border-subtle rounded-2xl">
          <p className="text-text-secondary text-xs font-mono uppercase tracking-wider">Average Content Safety Rating</p>
          <p className="text-brand-primaryxl font-bold text-[#10B981] mt-1.5">96.8%</p>
      ...
      <div className="bg-[#141416] border border-border-subtle rounded-2xl p-5">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-text-primary text-sm font-semibold">User Activity & Upload Expansion</h3>
          <span className="text-text-secondary text-[10px] font-mono uppercase tracking-widest border border-border-subtle px-2 py-0.5 rounded">Active telemetry curve</span>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-[#141416]/90 border border-border-subtle rounded-2xl p-5">
          <h3 className="text-text-primary text-sm font-semibold mb-4">Channel Category Distribution Ratio</h3>
        ...
        <div className="bg-[#141416] border border-border-subtle rounded-2xl p-5 flex flex-col justify-between">
          <div>
            <h3 className="text-text-primary text-sm font-semibold mb-3">Compliance Statistics</h3>
          ...
          <div className="gap-y-3 max-h-[190px] overflow-y-auto pr-1">
            {categories.map((c, i) => (
              <div key={c.id} className="flex items-center justify-between bg-white/[0.01] border border-border-subtle p-2 rounded-xl text-xs">
                <span className="text-text-primary font-medium">{c.name}</span>
                <span className="text-text-secondary font-mono font-bold bg-white/5 border border-border-subtle px-2 py-0.5 rounded">
