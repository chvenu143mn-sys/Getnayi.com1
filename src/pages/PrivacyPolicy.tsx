      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          <div className="bg-[#121214] border border-white/5 rounded-2xl p-4">
            ...
            <h3 className="text-sm font-semibold text-zinc-200">Bcrypt-12 Salted</h3>
            <p className="text-zinc-400 text-xs mt-1">Your password credentials are hashed on our server backend using deterministic salt parameters.</p>
          </div>
          <div className="bg-[#121214] border border-white/5 rounded-2xl p-4">
            <Eye className="size-5 text-blue-400 mb-2" />
            <h3 className="text-sm font-semibold text-zinc-200">No Broker Selling</h3>
            <p className="text-zinc-400 text-xs mt-1">We do not sell personal profile data, watch metrics, or search records to advertisement networks.</p>
          </div>
          <div className="bg-[#121214] border border-white/5 rounded-2xl p-4">
            <FileText className="size-5 text-purple-400 mb-2" />
            <h3 className="text-sm font-semibold text-zinc-200">Data Control</h3>
            <p className="text-zinc-400 text-xs mt-1">Request a complete JSON schema dump of your profile content or request account deletion instantly.</p>
          </div>
        </div>
          ...
          <section className="bg-[#121214] border border-white/5 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="p-4 bg-zinc-900/50 rounded-xl border border-white/5">
                <h4 className="text-zinc-200 font-semibold text-xs mb-1 flex items-center gap-x-1.5">
