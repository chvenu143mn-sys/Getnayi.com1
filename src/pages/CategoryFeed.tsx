  ...
  return (
    <div className="flex-1 w-full bg-bg-base text-text-primary font-sans flex flex-col h-full selection:bg-white/20 pb-[calc(60px+env(safe-area-inset-bottom))]">
      ...
      <div className="sticky top-0 z-20 bg-bg-base/80 backdrop-blur-md pt-6 pb-4 px-5 flex items-center">
        <GlobalBackButton className="p-2 -ml-2 bg-transparent hover:bg-surface-1 border-transparent" fallbackPath="/explore" iconClassName="size-6" />
        <h2 className="text-[19px] font-semibold text-text-primary ml-2 tracking-wide truncate">{category?.name || 'Category'}</h2>
      </div>
